...
class StoreServiceTest {
    ...
    void testAddAuctionProductToStore_Success() {
        ...
        assertTrue(storeId > 0, "Store ID should be a positive number");
        storeService.addProductToStore(storeId, 1, 101, "AuctionStore1",50.0,5);
    ...
    void testAddBidOnAuctionProductInStore_Success() {
        ...
        assertTrue(storeId > 0, "Store ID should be a positive number");
        storeService.addProductToStore(storeId, 1, 102, "AuctionStore2",50.0,5);
        // Adding an auction product to the store
    ...
    void testSendResponseForAuctionByOwner_Success() {
        ...
        assertTrue(storeId > 0, "Store ID should be a positive number");
        storeService.addProductToStore(storeId, 1, 104, "AuctionStore4",50.0,5);
        // Adding an auction product to the store
    ...
    void testGetAuctionProductsFromStore_Success() {
        ...
        assertTrue(storeId > 0, "Store ID should be a positive number");
        storeService.addProductToStore(storeId, 1, 105, "AuctionStore5",50.0,5);
        // Adding an auction product to the store
    ...
    void testAddBidOnAuctionProductInStore_BidTooLow() {
        ...
        assertTrue(storeId > 0, "Store ID should be a positive number");
        storeService.addProductToStore(storeId, 1, 106, "AuctionStore6",50.0,5);
        // Adding an auction product to the store
